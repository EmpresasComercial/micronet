...
import { BalanceCard } from './Profile/components/BalanceCard';
...
export default function Profile() {
  ...
  useEffect(() => {
    ...
    // Sincronização Realtime para o saldo e lucros
    const channel = supabase
      ...
      .on(
        ...
        () => {
          // Quando o saldo mudar no banco, atualizamos a interface automaticamente
          fetchProfile();
        }
      )
      .subscribe();
