      ...
      <div className="ms-card p-5 flex flex-col relative">
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-y-6 gap-x-4 pt-4 border-t border-black/5">
            ...
            <div className="flex flex-col text-sm">
              <span className="text-[10px] text-gray-400 uppercase font-bold tracking-tight mb-0.5">Retirada Total</span>
              <span className="font-bold text-gray-400">{formatCurrency(withdrawn, currency)}</span>
            </div>
          </div>
